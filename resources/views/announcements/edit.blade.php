                    ...
                    <div class="col-md-8">
                        <div class="row">
                            ...
                            <div class="col-md-12 form-group mb-3">
                                ...
                                <input type="text" name="title" id="title" class="form-control form-control-sm rounded-0" placeholder="Enter Leave title" value="{{old('title',$announcement->title)}}"/>
                            </div>
                            ...
                            <div class="col-md-12 form-group mb-3">
                                    ...
                                    <textarea  name="content" id="content" class="form-control form-control-sm rounded-0" rows="5" placeholder="Say Something...">{{old('title',$announcement->content)}}</textarea> 
                            </div>
